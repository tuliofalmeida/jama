#ifdef testControl
    #include "../../../headers/controlLibs/mp_pi.h"
#else
    #include "SistemasdeControle/headers/controlLibs/mp_pi.h"
#endif
...
template<typename Type>
LinAlg::Matrix<Type> ControlHandler::MP_PI<Type>::outputControlActionsCalc(LinAlg::Matrix<Type> Reference, LinAlg::Matrix<Type> SignalInput)
{
    this->error = Reference(0,0) - SignalInput(0,0); // Calcula o erro. OBS: Esse estado é obrigatório para encontrar o PI que será utilizado em uma iteração.
